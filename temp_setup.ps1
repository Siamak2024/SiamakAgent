# Multi-User Setup Script - Create all files
Write-Host "`n=== Creating Azure Functions ===" -ForegroundColor Cyan

# save-project/index.js
$saveProject = @"
...
$saveProject | Out-File -FilePath "azure-deployment\api\save-project\index.js" -Encoding UTF8
Write-Host "  ✓ save-project/index.js" -ForegroundColor Green

# Continued in next command...
